...
def log_likelihood2(theta):
	fPBH, mu_BH, csin, beta = theta
	return Log_likelihood(phistar_si, mu_BH, csin, 40., beta, fPBH)	
...
for idim in range(ndim):
	...
	plt.savefig("Bayesian_bound4_"+labels[idim]+"_400000_40Msol.png")
...
fn1 = open('/home/tejas/tejas/PBH_pheno/bayesian4_data_400000_40Msol.txt', 'w')
...
fig.savefig("bayesian4_posterior_40Msol_400000.png")

ftau = open('/home/tejas/tejas/PBH_pheno/bayesian4_tau_400000_40Msol.txt', 'w')
...
plt.title("tau estimate as a function of N, for fPBH, 40M_sol black hole")
plt.legend(fontsize=14)
plt.savefig("bayesian4_400000_40Msol_convergence.png")
