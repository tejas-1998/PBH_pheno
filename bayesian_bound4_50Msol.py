...
def log_likelihood2(theta):
	fPBH, mu_BH, csin, beta = theta
	return Log_likelihood(phistar_si, mu_BH, csin, 50., beta, fPBH)	
...
for idim in range(ndim):
	...
	plt.title("Plot of "+labels[idim]+" as a function of number of steps, for 50 M_sol Black hole")
	plt.savefig("Bayesian_bound4_"+labels[idim]+"_400000_50Msol.png")
...
fn1 = open('/home/tejas/tejas/PBH_pheno/bayesian4_data_400000_50Msol.txt', 'w')
...
fig.savefig("bayesian4_posterior_50Msol_400000.png")

ftau = open('/home/tejas/tejas/PBH_pheno/bayesian4_tau_400000_50Msol.txt', 'w')
...
plt.title("tau estimate as a function of N, for fPBH, 50M_sol black hole")
plt.legend(fontsize=14)
plt.savefig("bayesian4_400000_50Msol_convergence.png")
