...
sampler.run_mcmc(pos, 120000, progress=True)
...
fn1 = open('/home/tejas/bayesian4_data_120000_90Msol.txt', 'w')
...
fig.savefig("bayesian4_posterior_multi_90Msol_120000.png")
