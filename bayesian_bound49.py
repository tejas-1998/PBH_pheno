...
def log_prior(theta):
	...
	lp = 0.
	if 0.<=fPBH<=1. and 0.1<=mu_BH<=250. and 1.<=csin<=45. and 2.<beta<3.:
		lp = 0.
	else:
		lp = -np.inf
	return lp
...
def log_likelihood2(theta):
	fPBH, mu_BH, csin, beta = theta
	return Log_likelihood(phistar_si, mu_BH, csin, 90., beta, fPBH)	
...
for idim in range(ndim):
	...
	plt.title("Plot of "+labels[idim]+" as a function of number of steps, for 90 M_sol Black hole")
	plt.savefig("Bayesian_bound4_"+labels[idim]+"_200000_90Msol.png")
...
fn1 = open('/home/tejas/tejas/PBH_pheno/bayesian4_data_200000_90Msol.txt', 'w')
...
fig.savefig("bayesian4_posterior_90Msol_200000.png")

ftau = open('/home/tejas/tejas/PBH_pheno/bayesian4_tau_200000_90Msol.txt', 'w')
...
plt.title("tau estimate as a function of N, for fPBH, 90M_sol black hole")
plt.legend(fontsize=14)
plt.savefig("bayesian4_200000_90Msol_convergence.png")
