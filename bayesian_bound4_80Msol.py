...
def log_likelihood2(theta):
	fPBH, mu_BH, csin, beta = theta
	return Log_likelihood(phistar_si, mu_BH, csin, 80., beta, fPBH)	
...
for idim in range(ndim):
	...
	plt.title("Plot of "+labels[idim]+" as a function of number of steps, for 80 M_sol Black hole")
	plt.savefig("Bayesian_bound4_"+labels[idim]+"_400000_80Msol.png")
...
fn1 = open('/home/tejas/tejas/PBH_pheno/bayesian4_data_400000_80Msol.txt', 'w')
...
fig.savefig("bayesian4_posterior_80Msol_400000.png")

ftau = open('/home/tejas/tejas/PBH_pheno/bayesian4_tau_400000_80Msol.txt', 'w')
...
plt.title("tau estimate as a function of N, for fPBH, 80M_sol black hole")
plt.legend(fontsize=14)
plt.savefig("bayesian4_400000_80Msol_convergence.png")
